...
import com.kumpulanbaru.retrofits.paging3philipp_cleanarch.presentation.bottomnav.HomeActivity
                    ...
                    composable("signIn") {
                        ...
                        LaunchedEffect(key1 = state.isSignInSuccessful) {
                            if (state.isSignInSuccessful) {
                                Toast.makeText(applicationContext, "You just signed in", Toast.LENGTH_LONG).show()
                                val intent = Intent(applicationContext, HomeActivity::class.java)
                                startActivity(intent)
